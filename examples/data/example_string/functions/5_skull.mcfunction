...
execute unless score callback string matches 0.. run data modify storage string:in temp.string set from entity @p SelectedItem.tag.SkullOwner.Properties.textures[0].Value
