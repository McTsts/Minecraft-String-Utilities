...
execute unless score callback string matches 0.. run data modify storage string:in temp set value {string:" !\"#$%&'()*+,-./0123456789:<=>?ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]_abcdefghijklmnopqrstuvwxyz{|}~",callback:{command:"function example_string:6_all",id:1}}
