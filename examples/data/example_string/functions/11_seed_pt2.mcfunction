execute unless score callback string matches 1.. run data modify storage string:in temp set value {string:"",callback:{command:"function example_string:11_seed_pt2",id:1}}
