...
data modify storage string:in input append value {string:"abc",callback:{command:"function example_string:4_multi",id:1}}
...
data modify storage string:in input append value {string:"abcde",callback:{command:"function example_string:4_multi",id:1}}
execute unless score callback string matches 0.. run tellraw @a ["[#04] Input: ",{"storage":"string:in","nbt":"input[-1].string","interpret":false}]
data modify storage string:in input append value {string:"abcdefgh",callback:{command:"function example_string:4_multi",id:1}}
execute unless score callback string matches 0.. run tellraw @a ["[#04] Input: ",{"storage":"string:in","nbt":"input[-1].string","interpret":false}]
data modify storage string:in input append value {string:"123",callback:{command:"function example_string:4_multi",id:2}}
execute unless score callback string matches 0.. run tellraw @a ["[#04] Input: ",{"storage":"string:in","nbt":"input[-1].string","interpret":false}]
