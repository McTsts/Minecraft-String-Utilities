...
data modify storage case:main in set from storage simplify:main out[0]
function case:to_upper
data modify storage simplify:main out[0] set from storage case:main out
# Force Shorten >=9
