...
execute if data storage simplify:main {char:"_"} run data modify storage case:main in set from storage simplify:main in[0]
execute if data storage simplify:main {char:"_"} run function case:to_upper
execute if data storage simplify:main {char:"_"} run data modify storage simplify:main in[0] set from storage case:main out
