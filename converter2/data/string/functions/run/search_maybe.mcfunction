...
execute if score current string > total string run scoreboard players set searching string 0
execute if score current string matches ..0 run scoreboard players set searching string 0
